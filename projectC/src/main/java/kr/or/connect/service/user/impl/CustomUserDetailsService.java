...
import kr.or.connect.dto.user.CustomUserDetails;
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String loginId) throws UsernameNotFoundException {
        ...
        UserEntity customUser = userDbService.selectUser(loginId);
        ...
        List<UserRoleEntity> customRoles = userDbService.selectUserRoles(loginId);
