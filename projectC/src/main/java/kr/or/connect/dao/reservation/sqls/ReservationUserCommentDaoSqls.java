...
public class ReservationUserCommentDaoSqls {
    ...
    public static final String SELECT_RESERVATION_USER_COMMENT = "SELECT id, product_id, reservation_info_id, score, user_id, comment, create_date, modify_date " +
                                                                 "FROM reservation_user_comment" + ORDER_BY + LIMIT_CLAUSE;

    public static final String SELECT_RESERVATION_USER_COMMENT_BY_PRODUCT_ID = "SELECT id, product_id, reservation_info_id, score, user_id, comment, create_date, modify_date " +
    ...
    public static final String SELECT_USER_COMMENT_IMAGE_DETAIL_BY_USER_COMMENT_ID = "SELECT r_user_comment_image.id, reservation_info_id, reservation_user_comment_id, f_info.id as file_id, file_name, save_file_name, content_type, delete_flag, create_date, modify_date " +
