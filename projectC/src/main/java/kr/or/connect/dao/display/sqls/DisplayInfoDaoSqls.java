...
public class DisplayInfoDaoSqls {
    ...
    public static final String SELECT_ALL_DISPLAY_DETAIL_INFOS_LIMIT = SELECT_ALL + ORDER_BY_DISPLAY_INFO_ID + LIMIT_CLAUSE;
    public static final String SELECT_DISPAY_DETAIL_INFOS_BY_CATEGORY_ID_LIMIT = SELECT_ALL + BY_CATEGORY_ID + ORDER_BY_DISPLAY_INFO_ID + LIMIT_CLAUSE;

    public static final String SELECT_DISPLAY_INFO_BY_DISPLAY_ID = SELECT_ALL + BY_DISPLAY_ID;

    public static final String GET_DISPLAY_INFO_COUNT = "SELECT count(*) " +
                                                        "FROM display_info";

    public static final String GET_DISPLAY_INFO_COUNT_BY_CATEGORY_ID_LIMIT = "SELECT count(*) " +
